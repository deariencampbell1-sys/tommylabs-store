...
const CATALOG = {
  ...
  5: { name: 'Elegant Dragon',          amount: 5250, img: 'img/product-elegant-dragon-v2.webp' },
  6: { name: 'Purple Mandalorian Helmet', amount: 4410, img: 'img/product-purple-mandalorian-v2.webp' },
  7: { name: 'Green Cobra',             amount: 3675, img: 'img/product-gren-cobra-v2.webp' },
  8: { name: 'Purple Skull Flames',     amount: 3150, img: 'img/product-purpe-skull-flames-v2.webp' },
  9: { name: 'Black & White Owl',       amount: 3360, img: 'img/product-black-and-white-owl-v2.webp' },
  10: { name: 'Death Reaper Orange',    amount: 3675, img: 'img/product-deathr-reaper-orange-v2.webp' },
  11: { name: 'Phoenix Squawking Red',  amount: 4200, img: 'img/product-phoenix-squawking-red-v2.webp' },
  12: { name: 'White & Black Owl',      amount: 3360, img: 'img/product-white-and-black-owl-v2.webp' },
  13: { name: 'Phoenix Squawking Emerald', amount: 4200, img: 'img/product-phoenix-squawking-emerald-v2.webp' },
  14: { name: 'Stag Cup',               amount: 2625, img: 'img/product-stag-cup-v2.webp' },
  15: { name: 'Death Reaper',           amount: 3675, img: 'img/product-death-reaper-v2.webp' },
  16: { name: 'Black Owl Bowl',         amount: 3150, img: 'img/product-black-owl-bowl-v2.webp' },
  17: { name: 'Charcoal Mandalorian Helmet', amount: 4410, img: 'img/product-charcoal-mandalorian-v2.webp' },
  18: { name: 'Golden Owl',             amount: 3675, img: 'img/product-owl-golden-v2.webp' },
  19: { name: 'Purple Dragon Castle',   amount: 4725, img: 'img/product-purple-dragon-castle-v2.webp' },
  20: { name: 'Golden Heart with Wings', amount: 2625, img: 'img/product-golden-heart-with-wings-v2.webp' },
  21: { name: 'Silver Fox',             amount: 3360, img: 'img/product-silver-fox-v2.webp' },
  22: { name: 'Terminator Bust',        amount: 4725, img: 'img/product-terminator-bust-v2.webp' },
  23: { name: 'T-Rex',                  amount: 4410, img: 'img/product-trex-v2.webp' },
  24: { name: 'Grey Dragon Heart',      amount: 2835, img: 'img/product-grey-dragons-heart-v2.webp' },
  25: { name: 'Princess Leia Bust',     amount: 4200, img: 'img/product-princess-leia-bust-v2.webp' },
  26: { name: 'Batman Cowl',            amount: 4410, img: 'img/product-batman-cowl-v2.webp' },
  27: { name: 'Silver Beauty',          amount: 3675, img: 'img/product-silver-beauty-v2.webp' },
  28: { name: 'Eagle on Spire',         amount: 4200, img: 'img/product-eagle-on-spire-v2.webp' },
  29: { name: 'Golden Dragon',          amount: 4725, img: 'img/product-golden-dragon-v2.webp' },
  30: { name: 'Charcoal Eagle',         amount: 3990, img: 'img/product-charcoal-eagle-v2.webp' },
  31: { name: 'Red Dragon Ashtray',     amount: 2835, img: 'img/product-red-dragon-ash-tray-v2.webp' },
  32: { name: 'Wolf of Winter Ashtray', amount: 2835, img: 'img/product-wolf-of-winter-ashtray-fierce-v2.webp' },
  33: { name: 'Yoda Bust',              amount: 4200, img: 'img/product-yoda-bust-v2.webp' },
};
